...
function initMap() {
	map = new google.maps.Map(
		document.querySelector("#list-hotels-result aside .hotel-map"),
		{
			center: {
				lat: 34.397,
				lng: 20.644
...
$("#header .show-bars").on("click", function() {
...
if (
	document.querySelectorAll("#hot-hotel .hotel-image .image-items img").length >
	0
) {
	changeStart();
}
...
function changeStart() {
	setInterval(function() {
		...
		var imgs = document.querySelectorAll(
			"#hot-hotel .hotel-image .image-items img"
		);
